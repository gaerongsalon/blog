...
- Treat this as a pnpm workspace for the operator-supplied production blog domain.
...
- Frontend API requests are relative to the same origin under `/api/*`; do not point browser code at an auxiliary API domain unless the deployment model changes.
